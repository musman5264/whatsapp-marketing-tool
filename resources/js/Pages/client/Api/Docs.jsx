...
const ENDPOINTS = [
    ...
    },
    {
        ...
        items: [
            ...
            { method: 'POST', path: `${BASE}/messages/send`, descKey: 'api.ep_messages_send_media', scope: 'messages:write', body: '// Option A — upload a file (multipart/form-data):\n//   contact_id=42  channel=whatsapp  type=image\n//   caption=Your order shipped!  attachment=@photo.jpg\n\n// Option B — reference a public URL (application/json):\n{\n  "contact_id": 42,\n  "channel": "whatsapp",\n  "type": "document",\n  "media_url": "https://cdn.yoursite.com/invoice-99.pdf",\n  "filename": "invoice-99.pdf",\n  "caption": "Invoice for ORD-99"\n}', response: '{ "provider_message_id": "wamid.xxx", "status": "sent" }' },
        ],
    },
    {
                ...
                {tab === 'quickstart' && (
                    <div className="space-y-4">
                        {[
                            ...
                            { stepKey: 'api.quickstart_step_send_media', code: `curl -X POST \\\n     -H "Authorization: Bearer <token>" \\\n     -F "contact_id=42" \\\n     -F "channel=whatsapp" \\\n     -F "type=image" \\\n     -F "caption=Here is your receipt" \\\n     -F "attachment=@receipt.jpg" \\\n     ${window.location.origin}/api/v1/messages/send` },
