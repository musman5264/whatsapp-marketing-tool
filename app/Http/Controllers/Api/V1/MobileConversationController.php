...
class MobileConversationController extends WorkspaceScopedController
{
    ...
    public function reply(Request $request, string $uuid): JsonResponse
    {
        ...
        if ($request->hasFile('attachment')) {
            ...
            // Cloud API needs an uploaded media_id; WhatsApp Web sends by URL.
            if ($channel === 'whatsapp' && $conversation->channelAccount?->provider !== 'whatsapp_web') {
            ...
            } elseif ($conversation->channelAccount?->provider === 'whatsapp_web') {
